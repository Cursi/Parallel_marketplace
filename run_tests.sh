...
TESTS=tests
OUT=out
PYTHON_CMD=/mnt/c/Users/Cursi/AppData/Local/Programs/Python/Python38-32/python.exe
# PYTHON_CMD=C:\\Users\\Cursi\\AppData\\Local\\Programs\\Python\\Python38-32\\python.exe
# PYTHON_CMD=python3
# PYTHON_CMD=py
